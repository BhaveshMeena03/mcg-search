...
async def embed_texts(
    ...
    *,
    ...
    for i, batch in enumerate(batches):
        ...
        # requests/minute); on a paid key it adds 21s per batch for
        # nothing, which turned a 13-batch ingest into half an hour. The
        # 429 retry above is the real protection either way.
